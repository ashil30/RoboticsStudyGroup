...
if("FALSE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /notebooks/catkin_ws/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /notebooks/catkin_ws/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /notebooks/catkin_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/notebooks/catkin_ws/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /notebooks/catkin_ws/install/lib;/notebooks/catkin_ws/devel/lib;/opt/ros/melodic/lib)
